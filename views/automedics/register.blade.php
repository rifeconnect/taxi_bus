...
@section('title', 'AutoMedics | Register')

@section('heading', 'Registration Form')
...
@section('body')
	...
	<form class="form-horizontal" method="POST" action="/automedics">
   	{{csrf_field()}}
	  <fieldset>
	    ...
	    <div class="form-group">
	      <label for="inputSpecialization" class="col-lg-2 control-label">Area of Specialization</label>
	      <div class="col-lg-10">
	        <textarea class="form-control" rows="3" id="inputSpecialization" required name="specialization" placeholder="Area of specialization"></textarea>
	      </div>
	     </div>
	     <div class="form-group">
	      ...
	      <div class="col-lg-10">
	        <select class="form-control" id="inputState" required name="state">
	          <option selected="selected">Which state are you?</option>
